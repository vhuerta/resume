  ...
  <div class="col-xs-12">
    ...
    <div class="col-xs-12" style="border-bottom: dotted 1px #fff;">
      <div class="col-xs-12 comment">
        <p>
          <i class="fa fa-bookmark" style="color: #34cc34"></i>
          MxLabs - ({{$t('december')}} 2017 - {{$t('actual')}})
    ...
    <div class="col-xs-12" style="border-bottom: dotted 1px #fff;">
      <div class="col-sm-12 comment">
        <p>
          ...
          Claro video - ({{$t('july')}} 2017 - {{$t('december')}} 2018)
          <br>&nbsp;&nbsp;&nbsp;&nbsp;Senior Developer.
          <br>
          <br>
          &nbsp;&nbsp;&nbsp;&nbsp;{{$t('jobs.clarovideo')}}.
    ...
    <div class="col-xs-12" style="border-bottom: dotted 1px #fff;">
      <div class="col-sm-12 comment">
        <p>
          <i class="fa fa-bookmark"></i>
          Odintec - ({{$t('september')}} 2015 - {{$t('december')}} 2018)
    ...
    <div class="col-xs-12" style="border-bottom: dotted 1px #fff;">
      <div class="col-xs-12 comment">
        <p>
          <i class="fa fa-bookmark"></i>
          Compropago - ({{$t('september')}} 2016 - {{$t('july')}} 2017)
    ...
    <div class="col-xs-12" style="border-bottom: dotted 1px #fff;">
      <div class="col-xs-12 comment">
        <p>
          <i class="fa fa-bookmark"></i>
          Blackcore de México S.A. C.V. - ({{$t('december')}} 2012 - {{$t('september')}} 2016)
    ...
    <div class="col-xs-12" style="margin-top: 10px; border-bottom: dotted 1px #fff;">
      <div class="col-xs-12 comment">
        <p>
          <i class="fa fa-bookmark"></i>
          Mair 3D - ({{$t('november')}} 2011 - {{$t('late')}} 2013)
    ...
    <div class="col-xs-12" style="margin-top: 10px; border-bottom: dotted 1px #fff;">
      <div class="col-xs-12 comment">
        <p>
          ...
          Health Digital Systems - ({{$t('october')}} 2011 - {{$t('november')}} 2012)
    ...
    <div class="col-xs-12" style="margin-top: 10px; border-bottom: dotted 1px #fff;">
      <div class="col-xs-12 comment">
        <p>
          <i class="fa fa-bookmark"></i>
          Secretaria de Economia - ({{$t('august')}} 2011)
          <br>
          &nbsp;&nbsp;&nbsp;&nbsp;Developer. ({{$t('unique_project')}})
          <br>
          <br>
    ...
    <div class="col-xs-12" style="margin-top: 10px; border-bottom: dotted 1px #fff;">
      <div class="col-xs-12 comment">
        <p>
          <i class="fa fa-bookmark"></i>
          Operadora DIID - ({{$t('october')}} 2010 - {{$t('may')}} 2011)
          <br>&nbsp;&nbsp;&nbsp;&nbsp;Developer.
          <br>
          <br>
          &nbsp;&nbsp;&nbsp;&nbsp;{{$t('jobs.diid')}}.
